...
$string['enable_postwash'] = 'Enable postwash';
$string['enable_postwashdesc'] = 'Enable the postwash task to run after the data cleaner has completed. The postwash task will run following its scheduled time and will perform any additional cleaning tasks that are required after the main data cleaning has completed.';
...
$string['postwashcompleted'] = 'Postwash task completed.';
$string['postwashrunning'] = 'Running postwash task...';
$string['privacy:metadata'] = 'The local datacleaner plugin does not store any personal data.';
$string['progress'] = 'Progress';
$string['resetbutton'] = 'Reset URL';
$string['scheduledstaskpostwash'] = 'Data Cleaner Postwash Task';
$string['scheduledtaskpostwasherror'] = 'Data wash aborted due to safety checks failing. See the above logs for details.';
