...
/**
 * Settings for the replace urls cleaner.
 *
...
$settings->add(
    new admin_setting_configtextarea(
        ...
        new lang_string('skiptablesdesc', 'cleaner_replace_urls'),
        $defaultskiptables,
        PARAM_TEXT,
        60,
        5
...
$settings->add(
    new admin_setting_configcheckbox(
        'cleaner_replace_urls/cleanconfig',
        new lang_string('cleanconfig', 'cleaner_replace_urls'),
        new lang_string('cleanconfigdesc', 'cleaner_replace_urls'),
        0
    )
);
