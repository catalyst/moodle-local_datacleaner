...
$settings->add(new admin_setting_configtext('cleaner_users/minimumage', new lang_string('minimumage', 'cleaner_users'),
            new lang_string('minimumagedesc', 'cleaner_users'), 365, PARAM_INT));
